...
class CircleSubdivisionDrawer:
    def __init__(self, subdivision: CircleSubdivision) -> None:
        ...
        self._subdiv_batch = pyglet.graphics.Batch()
        self._circles = []
        self._opacity = 255
    ...
    def update_subdiv_batch(self):
        g = self._subdivision.get_subdivision_graph()
        if g is None:
            return
        
        add_graph_to_batch(g, self._subdiv_batch, color=(213, 94, 0))
